...
const DOTTED_ID_SEGMENT_PATTERN_SOURCE = "[A-Z](?:[A-Z0-9_]*[A-Z0-9])?";
const DOTTED_ID_PATTERN_SOURCE = `${DOTTED_ID_SEGMENT_PATTERN_SOURCE}(?:\\.${DOTTED_ID_SEGMENT_PATTERN_SOURCE})+`;
