...
- Next executable product task: `T21.3 — Add self-serve preview docs and issue templates`
- Last completed task: `T21.2 — Document PR report, policy examples, and Action troubleshooting`
