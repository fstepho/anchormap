...
- Last completed task: `T1.2 — Implement sandbox materialization from fixture input`
...
6. classification of any deviation using the taxonomy from operating-model.md
```
...
### Analyze one failing fixture

```text
Analyze fixture failure {fixture_id}.
...
Classify the failure with exactly one primary classification from operating-model.md §10:
- contract violation
- spec ambiguity
- design gap
- eval defect
...
5. whether tasks.md needs an update
```

### Update tasks after a classified deviation
