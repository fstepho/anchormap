...
- Next executable product task: `T11.4 — Close v1.1 `.js` specifier release readiness`
- Last completed task: `T11.3 — Preserve scan and map graph-validation behavior under v1.1`
